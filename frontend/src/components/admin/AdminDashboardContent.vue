<template>
  <div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" ref="deleteModal" aria-labelledby="deleteModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            ...
            <p class="text-muted mt-2 mb-0">
              <small>
                ...
                This will deactivate the user account. This action can be undone by reactivating.
              </small>
            </p>
          </div>
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        this.appointments = appointments.data.slice(0, 10)
